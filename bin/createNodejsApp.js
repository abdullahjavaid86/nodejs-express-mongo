...
if (process.argv.length < 3) {
  ...
  console.log('    npx create-nodejs-express-mongo-app my-app');
  console.log('    OR');
  console.log('    npm init create-nodejs-express-mongo-app my-app');
  process.exit(1);
}
...
const repo = 'https://github.com/abdullahjavaid86/nodejs-express-mongo.git';
